        ...
        <div class="d-flex justify-content-center flex-column rgt_cen">
          ...
          <form>
            <div class="form-simple">
              <ul>
                <li><label>Name</label><input placeholder="Daniel Thomas" type="text" /></li>
                <li><label>Address</label><input placeholder="65B/2, North Carolin Street, CA" type="text" /></li>
                <li><label>Coporate Agreement</label><input placeholder="sampletext@mail.com" type="text" /></li>
                <li><label>City</label><input placeholder="sampletext@mail.com" type="text" /></li>
                <li><label>Email Address</label><input placeholder="sampletext@mail.com" type="text" /></li>
              </ul>
  
  
              <div class="text-center">
                <mdb-btn type="button" class="log_btn">SignUP</mdb-btn>
              </div>
              ...
              <p class="new_taller">I'm already registered
                <a>
