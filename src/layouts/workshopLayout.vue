...
<div class="flexible-content workshop_content">
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <list-group class="list-group-flush">
        <router-link to="/Services_WW" @click.native="activeItem = 1">
          <list-group-item :action="true" :class="activeItem === 1 && 'active'"><img src="../assets/images/sidebar_icon/dash_icon.png"/> Services</list-group-item>
        </router-link>
        <router-link to="/Profile_WW" @click.native="activeItem = 2">
          <list-group-item :action="true" :class="activeItem === 2 && 'active'"><img src="../assets/images/sidebar_icon/vehicle_icon.png"/>Profile</list-group-item>
        </router-link>
          <router-link to="/Login_WW" @click.native="activeItem = 3">
          <list-group-item :action="true" :class="activeItem === 3 && 'active'"><img src="../assets/images/sidebar_icon/signout_icon.png"/>Sign Out</list-group-item>
        </router-link>
      </list-group>
    </div>
    <!-- /Sidebar  -->
